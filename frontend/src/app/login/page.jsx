    ...
    <div className="flex-grow bg-dark-950 flex font-sans min-h-[calc(100vh-64px)] overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-dark-900/40 relative items-center justify-center p-12 border-r border-dark-800/80">
        ...
        <div className="space-y-6 max-w-md relative z-10">
          ...
          <div className="flex items-center gap-3 bg-dark-950/60 border border-dark-800 p-4 rounded-2xl">
            <div className="text-primary-400 font-bold text-2xl font-outfit">99%</div>
            <p className="text-xs text-dark-400 font-light">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        <div className="glass-panel p-8 sm:p-10 rounded-3xl max-w-md w-full border-dark-800/80 shadow-2xl relative z-10">
          <div className="space-y-2 mb-8 text-center sm:text-left">
            <h1 className="text-3xl font-black font-outfit text-white">Welcome Back</h1>
            <p className="text-xs text-dark-400 font-light">Enter email credentials to open your dashboard.</p>
          </div>

          {error && (
            <div className="mb-6 flex items-center gap-2 p-3 bg-red-500/10 border border-red-500/25 rounded-2xl text-xs text-red-400 animate-shake">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="email" className="block text-[10px] font-bold text-dark-400 uppercase tracking-wider pl-1">
                Email Address
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-dark-950/50 border border-dark-800/80 rounded-xl text-sm text-dark-100 placeholder-dark-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all duration-200"
                  required
                />
                <Mail className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-dark-500" />
              </div>
            </div>

            {/* Password Field */}
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-[10px] font-bold text-dark-400 uppercase tracking-wider pl-1">
                Password
              </label>
              <div className="relative">
                <input
                  ...
                  required
                />
                <Lock className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-dark-500" />
              </div>
            </div>
