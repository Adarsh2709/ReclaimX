      ...
      <div className="flex flex-col md:flex-row flex-grow bg-transparent font-sans min-h-[calc(100vh-64px)]">
        ...
        <div className="flex-1 p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="border-b border-green-100 pb-6">
            <h1 className="text-3xl font-black font-outfit text-slate-850 tracking-tight flex items-center gap-3">
          ...
          {/* Filters Bar */}
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white/80 backdrop-blur-md border border-green-100/60 p-4 rounded-3xl shadow-sm shadow-green-950/2 animate-slide-up">
            {/* Search */}
            <div className="relative w-full md:w-72">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all duration-200"
              />
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 ${
                  statusFilter === 'ALL'
                    ...
                    : 'bg-slate-50 text-slate-500 hover:text-slate-800 hover:bg-slate-100 border border-slate-100'
                }`}
              >
                All
              </button>
          ...
          {loading ? (
            ...
            <div className="glass-card p-16 text-center border-dashed border-2 border-slate-200">
              <History className="h-10 w-10 text-slate-300 mx-auto mb-4" />
              <h3 className="text-base font-bold font-outfit text-slate-700 mb-1">No requests found</h3>
