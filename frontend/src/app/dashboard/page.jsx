      ...
      <div className="flex flex-col md:flex-row flex-grow bg-dark-950 font-sans min-h-[calc(100vh-64px)]">
        ...
        <div className="flex-1 p-6 md:p-8 space-y-8 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-dark-800/80 pb-6">
            <div>
              <h1 className="text-3xl font-black font-outfit text-white tracking-tight">Eco-Citizen Dashboard</h1>
              <p className="text-sm text-dark-400 font-light mt-1">
                Welcome back, <strong className="text-primary-400">{user?.name}</strong>. Monitor your environmental savings and schedule dispatches.
              </p>
            </div>
            
            <Link
              href="/pickup/create"
              className="inline-flex items-center gap-2 py-2.5 px-4 bg-primary-500 hover:bg-primary-600 text-dark-950 text-xs font-bold rounded-xl transition-all duration-200 shadow-md hover:shadow-primary-500/10"
            >
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold font-outfit text-white tracking-tight">My Active Dispatches</h2>
              <Link href="/pickup" className="text-xs font-bold text-primary-400 hover:text-primary-300 transition-colors inline-flex items-center gap-1">
                View History
            ...
            {loading ? (
              ...
              <div className="glass-panel p-12 text-center rounded-3xl border-dashed border-dark-800">
                ...
                <h3 className="text-base font-bold font-outfit text-dark-200 mb-1">No active pickups scheduled</h3>
                ...
                <Link
                  href="/pickup/create"
                  className="inline-flex items-center gap-2 py-2 px-4 bg-primary-500/10 hover:bg-primary-500 text-primary-400 hover:text-dark-950 text-xs font-bold rounded-xl transition-all border border-primary-500/20 hover:border-primary-500"
                >
